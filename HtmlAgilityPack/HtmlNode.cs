...
namespace HtmlAgilityPack
{
    ...
    public class HtmlNode : IXPathNavigable
    {
        ...
        internal System.Collections.Generic.Dictionary<string, string> _data;
        ...
        /// <summary>
        /// Gets the data field for this node. May not be null.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the current node has any Data added to it.
        /// </summary>
        public bool HasData
        {
            get
        ...
        public HtmlNode CloneNode(bool deep)
        {
            ...
            if (HasData)
            {
                foreach (System.Collections.Generic.KeyValuePair<string,string> dat in _data)
                {
                    node.Data.Add(dat.Key,dat.Value);
                }
            }
